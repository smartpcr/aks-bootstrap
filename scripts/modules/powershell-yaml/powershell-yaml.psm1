...
try {
    if ($PSVersionTable.PSEdition -eq "Core") {
        Add-Type -TypeDefinition $stringQuotingEmitterSource -ReferencedAssemblies $referenceList -Language CSharp -CompilerOptions "-nowarn:1701" -ErrorAction SilentlyContinue
    } else {
